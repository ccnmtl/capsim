...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RunRecord.title'
        db.add_column(u'sim_runrecord', 'title',
                      self.gf('django.db.models.fields.TextField')(default=u'', null=True, blank=True),
                      keep_default=False)

        # Adding field 'RunRecord.description'
        db.add_column(u'sim_runrecord', 'description',
                      self.gf('django.db.models.fields.TextField')(default=u'', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RunRecord.title'
        db.delete_column(u'sim_runrecord', 'title')

        # Deleting field 'RunRecord.description'
        db.delete_column(u'sim_runrecord', 'description')
